...
#define EUSART_SLAVE_Interrupt_CLEAR_Flag_bit() (PIR1bits.PSPIF=0)  // FOR SLAVE 
#define EUSART_SLAVE_Interrupt_READ_Flag_bit() (PIR1bits.PSPIF)        // FOR SLAVE 
#define EUSART_MASTER_Interrupt_CLEAR_Flag_bit() (PIR1bits.SSPIF=0)  // FOR MASTER 
#define EUSART_MASTER_Interrupt_READ_Flag_bit() (PIR1bits.SSPIF)        // FOR MASTER 
...
#define EUSART_SLAVE_INRERRUPT_ENABLE()  (PIE1bits.PSPIE=1)     // FOR SLAVE
#define EUSART_SLAVE_INRERRUPT_DISABLE()  (PIE1bits.PSPIE=0)    // FOR SLAVE
#define EUSART_MASTER_INRERRUPT_ENABLE()  (PIE1bits.SSPIE=1)    // FOR MASTER
#define EUSART_MASTER_INRERRUPT_DISABLE()  (PIE1bits.SSPIE=0)    // FOR MASTER
...
#define EUSART_SLAVE_ENABLE_HIGH_PRIORITY()    (IPR1bits.PSPIP=1)    // FOR SLAVE
#define EUSART_SLAVE_ENABLE_LOW_PRIORITY()    (IPR1bits.PSPIP=0)     // FOR SLAVE
#define EUSART_MASTER_ENABLE_HIGH_PRIORITY()    (IPR1bits.SSPIP=1)   // FOR MASTER
#define EUSART_MASTER_ENABLE_LOW_PRIORITY()    (IPR1bits.SSPIP=0)    // FOR MASTER
#endif
#endif
