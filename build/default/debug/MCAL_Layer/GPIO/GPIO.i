...
# 14 "MCAL_Layer/GPIO/GPIO.h" 2

# 1 "MCAL_Layer/GPIO/../mcal_std.h" 1
# 14 "MCAL_Layer/GPIO/../mcal_std.h"
# 1 "MCAL_Layer/GPIO/../std_lib.h" 1
# 15 "MCAL_Layer/GPIO/../std_lib.h"
...
# 15 "MCAL_Layer/GPIO/../std_lib.h" 2
...
# 16 "MCAL_Layer/GPIO/../std_lib.h" 2

# 1 "MCAL_Layer/GPIO/../../Bit_Math.h" 1
# 17 "MCAL_Layer/GPIO/../std_lib.h" 2
...
# 18 "MCAL_Layer/GPIO/../std_lib.h" 2
...
# 14 "MCAL_Layer/GPIO/../mcal_std.h" 2
...
# 15 "MCAL_Layer/GPIO/../mcal_std.h" 2
...
# 15 "MCAL_Layer/GPIO/GPIO.h" 2

# 1 "MCAL_Layer/GPIO/../device_config.h" 1
# 16 "MCAL_Layer/GPIO/GPIO.h" 2

# 1 "MCAL_Layer/GPIO/gpio_cfg.h" 1
# 17 "MCAL_Layer/GPIO/GPIO.h" 2
# 49 "MCAL_Layer/GPIO/GPIO.h"
typedef enum
{
    GPIO_LOW=0,
    GPIO_HIGH
...
Std_ReturnType gpio_pin_direction_int(const pin_cfg_t *pin_cfg)
{
    ...
    if(((void*)0)!=pin_cfg)
    {
        ...
        {
            case GPIO_OUTPUT:
                (*Tris_Regs[pin_cfg->port]&=~(1<<pin_cfg->pin));
                return_status=(0x00u);
                break;
...
# 50 "MCAL_Layer/GPIO/GPIO.c"
Std_ReturnType gpio_pin_get_direction_state(const pin_cfg_t *pin_cfg,direction_t *direction)
{
    Std_ReturnType return_status=(0x01u);
    if(((void*)0)!=pin_cfg && ((void*)0)!=direction)
    {
        *direction=((*Tris_Regs[pin_cfg->port]>>pin_cfg->pin)&0x01);
        return_status=(0x00u);
    }
    return return_status;
}
...
Std_ReturnType gpio_pin_write_level(const pin_cfg_t *pin_cfg,level_t level)
{
    ...
    if(((void*)0)!=pin_cfg)
    {
        ...
        {
            case GPIO_HIGH:
                 (*(Lat_Regs[pin_cfg->port])|=(1<<pin_cfg->pin));
...
{
    Std_ReturnType return_status=(0x01u);
    if(((void*)0)!=pin_cfg && ((void*)0)!=level)
    {
        *level=((*Port_Regs[pin_cfg->port]>>pin_cfg->pin)&0x01);
        return_status=(0x00u);
    }
    return return_status;
}
