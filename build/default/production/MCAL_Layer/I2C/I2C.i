...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/I2C/I2C.c" 2
# 1 "MCAL_Layer/I2C/I2C.h" 1
# 12 "MCAL_Layer/I2C/I2C.h"
...
# 12 "MCAL_Layer/I2C/I2C.h" 2

# 1 "MCAL_Layer/I2C/../mcal_std.h" 1
# 14 "MCAL_Layer/I2C/../mcal_std.h"
# 1 "MCAL_Layer/I2C/../std_lib.h" 1
# 15 "MCAL_Layer/I2C/../std_lib.h"
...
# 16 "MCAL_Layer/I2C/../std_lib.h" 2

# 1 "MCAL_Layer/I2C/../../Bit_Math.h" 1
# 17 "MCAL_Layer/I2C/../std_lib.h" 2
...
# 14 "MCAL_Layer/I2C/../mcal_std.h" 2

# 1 "MCAL_Layer/I2C/../Compiler.h" 1
# 14 "MCAL_Layer/I2C/../Compiler.h"
...
# 14 "MCAL_Layer/I2C/../Compiler.h" 2
# 15 "MCAL_Layer/I2C/../mcal_std.h" 2
...
# 13 "MCAL_Layer/I2C/I2C.h" 2

# 1 "MCAL_Layer/I2C/../device_config.h" 1
# 14 "MCAL_Layer/I2C/I2C.h" 2

# 1 "MCAL_Layer/I2C/../GPIO/GPIO.h" 1
# 17 "MCAL_Layer/I2C/../GPIO/GPIO.h"
# 1 "MCAL_Layer/I2C/../GPIO/gpio_cfg.h" 1
# 17 "MCAL_Layer/I2C/../GPIO/GPIO.h" 2
# 49 "MCAL_Layer/I2C/../GPIO/GPIO.h"
typedef enum
{
    GPIO_LOW=0,
    GPIO_HIGH
...
# 15 "MCAL_Layer/I2C/I2C.h" 2

# 1 "MCAL_Layer/I2C/../Interrupt/Interrupt_cfg.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/Interrupt_cfg.h"
# 1 "MCAL_Layer/I2C/../Interrupt/interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/Interrupt_cfg.h" 2
# 42 "MCAL_Layer/I2C/../Interrupt/Interrupt_cfg.h"
typedef enum{
    PRORITY_LOW =0,
    PRIORITY_HIGH
}priority_t;
# 16 "MCAL_Layer/I2C/I2C.h" 2

# 1 "MCAL_Layer/I2C/../../MCAL_Layer/Interrupt/Interrupt_internal.h" 1
# 17 "MCAL_Layer/I2C/I2C.h" 2
# 101 "MCAL_Layer/I2C/I2C.h"
typedef enum{
...
# 1 "MCAL_Layer/I2C/I2C.c" 2
   ...
   static void (* i2c_callback_ptr)(void)=((void*)0);
   static void (* recive_overflow_callback_ptr)(void)=((void*)0);
   static void (* write_collision_callback_ptr)(void)=((void*)0);
...
Std_ReturnType i2c_int(const i2c_t *ptr){
    ...
    if(((void*)0)!=ptr){
        ...
        if((1)==ptr->i2c_cfg.i2c_mode){
            switch(ptr->i2c_cfg.i2c_sub_mode){
                case I2C_MASTER_MODE:
                    (SSPCON1bits.SSPM=ptr->i2c_cfg.i2c_sub_mode);
                    SSPADD=(uint8)((8000000UL/(4.0*ptr->i2c_clock))-1);
                    break;
        ...
        else if((0)==ptr->i2c_cfg.i2c_mode){


            if((1) == ptr->i2c_cfg.i2c_general_call){
                (SSPCON2bits.GCEN=1);
            }
            else if((0) == ptr->i2c_cfg.i2c_general_call){
                (SSPCON2bits.GCEN=0);
            }
            else{
        ...
        if((0) == ptr->i2c_cfg.i2c_speed_mode){
            (SSPSTATbits.SMP=0);
        }
        else if((1) == ptr->i2c_cfg.i2c_speed_mode){
            (SSPSTATbits.SMP=1);
        }
        else{
        ...
        if((1) == ptr->i2c_cfg.i2c_speed_mode){
            (SSPSTATbits.CKE=1);
        }
        else if((0) == ptr->i2c_cfg.i2c_speed_mode){
            (SSPSTATbits.CKE=0);
        }
        else{
