...
# 1 "MCAL_Layer/ADC/../mcal_std.h" 1
# 14 "MCAL_Layer/ADC/../mcal_std.h"
# 1 "MCAL_Layer/ADC/../std_lib.h" 1
# 15 "MCAL_Layer/ADC/../std_lib.h"
...
# 16 "MCAL_Layer/ADC/../std_lib.h" 2

# 1 "MCAL_Layer/ADC/../../Bit_Math.h" 1
# 17 "MCAL_Layer/ADC/../std_lib.h" 2
...
# 14 "MCAL_Layer/ADC/../mcal_std.h" 2

# 1 "MCAL_Layer/ADC/../Compiler.h" 1
# 14 "MCAL_Layer/ADC/../Compiler.h"
...
# 15 "MCAL_Layer/ADC/../mcal_std.h" 2
...
# 13 "MCAL_Layer/ADC/ADC.h" 2

# 1 "MCAL_Layer/ADC/../device_config.h" 1
# 14 "MCAL_Layer/ADC/ADC.h" 2

# 1 "MCAL_Layer/ADC/../GPIO/GPIO.h" 1
# 17 "MCAL_Layer/ADC/../GPIO/GPIO.h"
# 1 "MCAL_Layer/ADC/../GPIO/gpio_cfg.h" 1
# 17 "MCAL_Layer/ADC/../GPIO/GPIO.h" 2
# 49 "MCAL_Layer/ADC/../GPIO/GPIO.h"
typedef enum
{
    GPIO_LOW=0,
    GPIO_HIGH
...
# 1 "MCAL_Layer/ADC/../Interrupt/Interrupt_cfg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/Interrupt_cfg.h"
# 1 "MCAL_Layer/ADC/../Interrupt/interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/Interrupt_cfg.h" 2
# 42 "MCAL_Layer/ADC/../Interrupt/Interrupt_cfg.h"
typedef enum{
    PRORITY_LOW =0,
    PRIORITY_HIGH
}priority_t;
...
# 1 "MCAL_Layer/ADC/../../MCAL_Layer/Interrupt/Interrupt_internal.h" 1
# 17 "MCAL_Layer/ADC/ADC.h" 2

# 1 "MCAL_Layer/ADC/ADC_cfg.h" 1
# 18 "MCAL_Layer/ADC/ADC.h" 2
# 75 "MCAL_Layer/ADC/ADC.h"
typedef enum{
    Channel_0_A0=0,
            Channel_1_A1,
            Channel_2_A2,
...
static __attribute__((inline)) void adc_pin_cfg(analog_channel_select_t analog_channel_select);
static __attribute__((inline)) void adc_Vref_cfg(const adc_t *adc);
static __attribute__((inline)) void adc_reading_mode_cfg(const adc_t *adc);


static void(* ADC_Interrupt_handler)(void)=((void*)0);
# 21 "MCAL_Layer/ADC/ADC.c"
Std_ReturnType adc_int(const adc_t *adc){
...
Std_ReturnType adc_reading_value(const adc_t *adc,uint16 *value){
    ...
    if(((void*)0)!=adc && ((void*)0)!=value){
       if((0x01u)==adc->reading_mode){
            *value=(uint16)((ADRESH << 8)+ADRESL);
        }
        else if((0x00u)==adc->reading_mode){
...
Std_ReturnType adc_is_conversion_done(const adc_t *adc,uint8 *statuse){
    ...
    if(((void*)0)!=adc && ((void*)0)!=statuse){
        *statuse=(uint8)(!((ADCON0bits.GO_nDONE)));
        returt_statuse=(0x00u);
    }
    return returt_statuse;
}
...
static __attribute__((inline)) void adc_Vref_cfg(const adc_t *adc){
    ...
    if(((void*)0)!=adc && ((void*)0)!=adc){

        if((0x01u) == adc->voltage_refrence_mode){
            do{ADCON1bits.VCFG1=1; ADCON1bits.VCFG0=1; }while(0);
        }
        else if((0x00u)==adc->voltage_refrence_mode){
