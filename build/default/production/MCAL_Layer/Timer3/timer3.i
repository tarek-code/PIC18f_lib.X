...
# 12 "MCAL_Layer/Timer3/timer3.h" 2

# 1 "MCAL_Layer/Timer3/../mcal_std.h" 1
# 14 "MCAL_Layer/Timer3/../mcal_std.h"
# 1 "MCAL_Layer/Timer3/../std_lib.h" 1
# 15 "MCAL_Layer/Timer3/../std_lib.h"
...
# 15 "MCAL_Layer/Timer3/../std_lib.h" 2
...
# 16 "MCAL_Layer/Timer3/../std_lib.h" 2

# 1 "MCAL_Layer/Timer3/../../Bit_Math.h" 1
# 17 "MCAL_Layer/Timer3/../std_lib.h" 2
...
# 18 "MCAL_Layer/Timer3/../std_lib.h" 2
...
# 14 "MCAL_Layer/Timer3/../mcal_std.h" 2

# 1 "MCAL_Layer/Timer3/../Compiler.h" 1
# 14 "MCAL_Layer/Timer3/../Compiler.h"
...
# 14 "MCAL_Layer/Timer3/../Compiler.h" 2
# 15 "MCAL_Layer/Timer3/../mcal_std.h" 2
...
# 1 "MCAL_Layer/Timer3/../GPIO/GPIO.h" 1
# 17 "MCAL_Layer/Timer3/../GPIO/GPIO.h"
# 1 "MCAL_Layer/Timer3/../GPIO/gpio_cfg.h" 1
# 17 "MCAL_Layer/Timer3/../GPIO/GPIO.h" 2
# 49 "MCAL_Layer/Timer3/../GPIO/GPIO.h"
typedef enum
{
    GPIO_LOW=0,
    GPIO_HIGH
...
# 15 "MCAL_Layer/Timer3/timer3.h" 2

# 1 "MCAL_Layer/Timer3/../Interrupt/Interrupt_cfg.h" 1
# 15 "MCAL_Layer/Timer3/../Interrupt/Interrupt_cfg.h"
# 1 "MCAL_Layer/Timer3/../Interrupt/interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/Timer3/../Interrupt/Interrupt_cfg.h" 2
# 42 "MCAL_Layer/Timer3/../Interrupt/Interrupt_cfg.h"
typedef enum{
    PRORITY_LOW =0,
    PRIORITY_HIGH
}priority_t;
# 16 "MCAL_Layer/Timer3/timer3.h" 2
...
# 1 "MCAL_Layer/Timer3/timer3.c" 2
   ...
   static void (* timer3_callback_ptr)(void)=((void*)0);
...
Std_ReturnType timer3_int(const timer3_t *ptr){
    ...
    if(((void*)0)!=ptr){
        ...
        if((0)==ptr->timer3_mode){
            (T3CONbits.TMR3CS=0);
        }
        else{
            (T3CONbits.TMR3CS=1);
            if((0) == ptr->timer3_syn_mode){
